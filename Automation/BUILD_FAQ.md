# LevEngine - FAQ по системе сборки
...
- Ninja/Manual: `build/bin/LevEngine.exe`
- CLion Debug: `cmake-build-debug/bin/LevEngine.exe`
- CLion Release: `cmake-build-release/bin/LevEngine.exe`
- Visual Studio: `vs-build/bin/LevEngine.exe`
