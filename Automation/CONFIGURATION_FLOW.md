...
Когда вы выбираете ту или иную конфигурацию в системе автоматизации сборки LevEngine, происходит следующий процесс:
...
def get_cmake_generate_command():
    args = [
        '"cmake"',
        '-S "C:/DEVOPS/LevEngine"',  # Исходники
...
```bash
cmake -S "C:/DEVOPS/LevEngine" -B "build-msvc" -G "Ninja" ...
```
